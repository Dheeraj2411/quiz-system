                ...
                <ul class="border-gray-300 border-2 rounded-md overflow-hidden">
                    <li class="font-bold p-2 bg-gray-200">
                        <ul class="flex justify-between items-center">
                            ...
                            <li class="flex-1 px-2">Question</li>
                            <li class="w-24 lg:w-32 text-center">Result</li>
                        </ul>
                    </li>
                    ...
                    <li class="even:bg-gray-300 p-2">
                        <ul class="flex justify-between items-center">
                            ...
                            <li class="flex-1 px-2">{{$item->question}}</li>
                            @if ($item->is_correct)
                            <li class="w-24 lg:w-32 text-center bg-green-600 rounded-xl">Correct</li>
                            @else
                            <li class="w-24 lg:w-32 text-center bg-red-600 rounded-xl">Incorrect</li>
                            @endif
                        </ul>
                    </li>
                    @endforeach
