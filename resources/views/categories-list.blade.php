...
<body>
    ...
    <div class="bg-gray-100 flex flex-col items-center min-h-screen px-4 sm:px-6 lg:px-8 ">
        ...
        @endif
        <h1 class="text-2xl sm:text-3xl lg:text-4xl text-green-900 p-5 font-bold text-center">Quiz Category</h1>
        ...
        <div class="w-full max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-5xl">
            <h1 class="text-xl sm:text-2xl text-green-900 text-center font-bold my-5">Top Category </h1>
                ...
                <ul class="border-gray-300 border-2 rounded-md overflow-hidden">
                    <li class="font-bold p-2 bg-gray-200">
                        <ul class="flex justify-between items-center">
                            ...
                            <li class="w-24 lg:w-32 text-center">Quiz Count</li>
                            <li class="w-20 lg:w-24 text-center">Action</li>
                        </ul>
                    </li>
